...
class _MyHomePageState extends State<MyHomePage> {
  ...
  static const platform = const MethodChannel('com.jzm.anp.flutter/version');
  String _versionName = 'Unknown';

  Future<void> getVersionName() async {
    String versionName;
    try {
      final String result = await platform.invokeMethod('getVersionName');
      versionName = result;
    } on PlatformException catch(e) {
      versionName = e.message;
    }
